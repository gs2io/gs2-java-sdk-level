...
public class DescribeStatusByUserIdRequest extends Gs2BasicRequest<DescribeStatusByUserIdRequest> {
	 ...
	 * @return this
	 */
	public DescribeStatusByUserIdRequest withResourcePoolName(String resourcePoolName) {
	 ...
	 * @return this
	 */
	public DescribeStatusByUserIdRequest withUserId(String userId) {
		setUserId(userId);
		return this;
	}
	 ...
	 * @return this
	 */
	public DescribeStatusByUserIdRequest withPageToken(String pageToken) {
	 ...
	 * @return this
	 */
	public DescribeStatusByUserIdRequest withLimit(Integer limit) {
		setLimit(limit);
		return this;
	}
